<%@ Page Language="C#" Title="Register an external login" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="SessionState_N_ViewState_N_ApplicationState.Account.RegisterExternalLogin" %>
