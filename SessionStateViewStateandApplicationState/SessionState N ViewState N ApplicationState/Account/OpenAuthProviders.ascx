<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="SessionState_N_ViewState_N_ApplicationState.Account.OpenAuthProviders" %>
